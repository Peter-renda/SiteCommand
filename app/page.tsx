            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_520px] gap-14 xl:gap-20 items-center">
                ...
                <div className="relative hidden lg:block animate-scale-in delay-200">
                  ...
                  {/* Dark console frame → white screen */}
                  <div
                    className="relative rounded-2xl p-2"
                    style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "0 40px 80px rgba(0,0,0,0.5)" }}
                  >
                    <div className="rounded-[12px] overflow-hidden" style={{ background: "#FFFFFF" }}>
                      {/* Training banner strip */}
                      <div
                        className="px-5 py-2.5 flex items-center justify-between"
                        style={{ background: "#FEF3C7", borderBottom: "1px solid rgba(180,83,9,0.18)" }}
                      >
                        <div className="flex items-center gap-2">
                          <span className="w-1.5 h-1.5 rounded-full sc-glow" style={{ background: "#B45309" }} />
                          <span className="font-mono text-[10px] font-semibold tracking-wide uppercase" style={{ color: "#92400E" }}>
                            SiteCommand Training
                          </span>
                        </div>
                        <span className="text-[10px]" style={{ color: "#B45309" }}>Kane Hall Renovation</span>
                      </div>

                      {/* Day header */}
                      <div className="px-5 py-3.5 border-b flex items-center justify-between" style={{ borderColor: "rgba(0,0,0,0.05)" }}>
                        <div className="flex items-baseline gap-2">
                          <span className="font-display text-lg text-gray-950">Day 14</span>
                          <span className="text-xs text-gray-400">Foundations &amp; Site Utilities</span>
                        </div>
                        <span className="px-2 py-0.5 font-mono text-[10px] font-medium rounded-full" style={{ color: "#1D4ED8", background: "#EFF6FF", border: "1px solid #BFDBFE" }}>
                          Phase 2 / 6
                        </span>
                      </div>
                      ...
                      <div className="px-5 py-4 space-y-2.5">
                        {[
                          ...
                          <div key={task.t} className="flex items-start gap-2.5">
                            ...
                            <span className={`text-xs flex-1 leading-snug ${task.done ? "text-gray-400 line-through" : "text-gray-700"}`}>
                              {task.t}
                            </span>
                            <span className="px-1.5 py-0.5 font-mono text-[9px] font-medium rounded text-gray-500 bg-gray-100 shrink-0">
                              {task.chip}
                            </span>
                          </div>
                        ))}
                      ...
                      <div className="px-5 pb-4">
                        <div className="rounded-lg px-3 py-2.5 flex items-center gap-2.5" style={{ background: "rgba(37,99,235,0.06)", border: "1px solid rgba(37,99,235,0.12)" }}>
