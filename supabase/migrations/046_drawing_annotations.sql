...
-- One annotation record per user per drawing (upsert pattern)
CREATE UNIQUE INDEX IF NOT EXISTS drawing_annotations_user_drawing
  ON drawing_annotations(drawing_id, created_by);
